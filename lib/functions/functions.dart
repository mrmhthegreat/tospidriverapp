...
//base url
String url =
    'https://tospi.app/'; //aAIzaSyDlgqqA6wnTMuHqx_uShXx_g91Yk83s4wgdd '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyDlgqqA6wnTMuHqx_uShXx_g91Yk83s4wg';
...
getUserDetails() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      onUserLogin(userDetails['name'],
          userDetails['mobile'].toString().replaceAll("+", "0"));
      result = true;
    } else if (response.statusCode == 401) {
      result = 'logout';
    } else {
...
void onUserLogin(String id, String name) {
  ...
  ZegoUIKitPrebuiltCallInvitationService().init(
    appID: 681909233 /*input your AppID*/,
    appSign:
        "dcc164f64882cc16a51cc99ef2aec1502256c6b94e697a1cb1b680c86964189d" /*input your AppSign*/,
    userID: name,
    userName: id,
...
makingPhoneCall(phnumber, {String name = ""}) async {
  ...
  if (name != "") {
    try {
      ...
      ZegoSendCallInvitationButton(
        ...
        invitees: [
          ZegoUIKitUser(
            id: phnumber.toString().replaceAll("+", "0"),
            name: name,
          ),
        ],
      );
